package designPatterns.prototypeRegstry;
...
class Client{
    public static void main(String[] args) {
        ...
        //We should copy the student obj then modify our current obj
        //If we miss the copy the same student object will be referenced
